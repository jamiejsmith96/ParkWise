...
export const metadata = {
  title: 'Static Caravan Buyers Guide | ParkWise',
  description: 'Complete guide to buying a static caravan in the UK. Learn about costs, financing, park fees, and what to look for.',
}
